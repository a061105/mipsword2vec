#ifndef MIPS_SKIPGRAM_LOSS_H
#define MIPS_SKIPGRAM_LOSS_H

#include "util.h"
#include "multi.h"
#include "function.h"

class MIPSSkipgramLoss: public Function{
		
		public:
		MIPSSkipgramLoss(Problem* _prob, Model* _model, int _query_size){
					prob = _prob;
					model = _model;
